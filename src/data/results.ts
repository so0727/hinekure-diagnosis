...
export const RESULTS: Record<string, CharacterType> = {
    ...
    'HOPK': {
        ...
        traits: ["自己中", "パワハラ気質", "感情失禁", "瞬間湯沸かし器"],
        color: '#FFB7B2',
    ...
    'HIPK': {
        ...
        traits: ["かまってちゃん", "情緒不安定", "自己陶酔", "承認欲求モンスター"],
        color: '#C7CEEA',
    ...
    'HIPS': {
        ...
        traits: ["依存体質", "自己肯定感低", "尽くしすぎ", "主体性ゼロ"],
        color: '#C7CEEA',
    ...
    'COPK': {
        ...
        traits: ["冷酷無比", "サイコパス疑惑", "成果主義", "人間味ゼロ"],
        color: '#B5EAD7'
    },
    'COPS': {
        id: 'COPS',
        ...
        title: '殺し屋',
        catchphrase: "",
        description: "あなたは、誰とも群れず、淡々と自分の任務を遂行する「殺し屋」タイプです。組織のしがらみや人間関係の泥沼には一切興味がなく、自分のスキルと利益のためだけに動きます。他人に共感することが極めて稀で、人が泣いていても「で？」としか思いません。そのドライさはある意味で清々しいですが、冷たすぎて「血が通っていない」と言われることも。他人を利用することに罪悪感がなく、自分の目的のためなら平気で裏切れる怖さを持っています。",
        traits: ["孤高", "損得勘定", "薄情", "マシーン"],
        color: '#B5EAD7'
    },
    'COLK': {
        id: 'COLK',
    ...
    'CIPS': {
        ...
        title: '宇宙人',
        catchphrase: "",
        description: "あなたは、地球の常識が通用しない「宇宙人」タイプです。独自の価値観と論理で生きており、他人が何を考えているのか全く理解できないし、理解しようともしません。悪気なく失礼なことを言ったり、空気を凍らせる行動を取ったりしますが、本人には自覚がありません。孤独を感じることもなく、むしろ一人でいる方が快適。社会不適合者スレスレですが、特定の分野では天才的な才能を発揮することもあります。",
